...
تم استخدام 97‎%‎ من مساحة التخزين … 
إذا نفدت مساحة التخزين، لن يكون بإمكانكَ إنشاء الملفات أو تعديلها أو تحميلها. استفِد من مساحة تخزين بسعة 100 غيغابايت مقابل ‏١٤٫٩٩ ج.م.‏‏ ‏٣٫٦٩ ج.م.‏ شهريًا لمدة 3 أشهر.
test_console.py‏
